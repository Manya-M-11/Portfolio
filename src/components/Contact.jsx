      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <div className="flex-1">
            ...
            <p>I’m eager to learn and collaborate! Feel free to reach out if you want to connect or discuss ideas.</p>
            <div className='mb-4 mt-8'>
                <FaEnvelope className='inline-block text-green-400 mr-2'></FaEnvelope>
                <a href="mailto:manyamsmg@gmail.com" className='hover:underline'>
                    manyamsmg@gmail.com
                </a>
            </div>
            <div className='mb-4'>
                <FaLinkedin className='inline-block text-green-400 mr-2'></FaLinkedin>
                <a href="https://www.linkedin.com/in/Manya M" 
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="hover:underline">

                    www.linkedin.com/in/manya-m-9a273629a
