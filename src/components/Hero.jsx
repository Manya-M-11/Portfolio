  ...
  return (
    <div className='bg-black text-white text-center py-16'>
      ...
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Manya M</span>
        ,BTECH Student At Alliance University 
      </h1>
      <p className='mt-4 text-lg text-gray-300'>
          I’m a technology enthusiast with a strong interest in frontend development
